...
<head>
    ...
    <title>{{ __('auth.login') }} - EurystheusAI</title>
    ...
    <main class="flex-grow flex items-center justify-center p-6">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400">{{ __('auth.continue_journey') }}</p>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center">
                            <input type="checkbox" name="remember" class="rounded border-gray-300 dark:border-gray-600 text-orange-500 dark:text-yellow-400 focus:ring-orange-500 dark:focus:ring-yellow-400 transition-colors">
                            <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('auth.remember_me') }}</span>
                        </label>
                        <a href="#" class="text-sm text-orange-500 dark:text-yellow-400 hover:underline">
            ...
            <p class="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
                {{ __('auth.no_account') }}
                <a href="{{ route('register') }}" class="font-medium text-orange-500 dark:text-yellow-400 hover:underline">
