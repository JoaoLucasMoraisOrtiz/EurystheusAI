...
<head>
    ...
    <title>Política de Privacidade - EurystheusAI</title>
...
<body class="font-sans antialiased theme-light">
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <main class="container mx-auto px-6 py-12">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Política de Privacidade</h1>
            <div class="prose dark:prose-invert max-w-none">
                <p>Aqui você pode inserir o conteúdo completo da Política de Privacidade da EurystheusAI.</p>
                <!-- Adicione o texto da política aqui -->
            </div>
        </main>
